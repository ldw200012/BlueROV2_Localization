...
# Topic Names to be Published
ROS_PUBLISHER_NAME_RAW = 'dvl/json_data'
ROS_PUBLISHER_NAME = 'dvl/data'
...
from bluerov2_kalmanfilter.msg import DVLBeam
import select
...
def publisher():
	pub_raw = rospy.Publisher(ROS_PUBLISHER_NAME_RAW, String, queue_size=10)
	pub = rospy.Publisher(ROS_PUBLISHER_NAME, DVL, queue_size=10)
